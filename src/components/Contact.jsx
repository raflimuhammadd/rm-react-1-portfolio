    ...
    bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        ...
        max-w-screen-lg mx-auto h-full">
            <div className="pb-8">
                ...
                <p className="py-6">Submit The Form Bellow</p>
            </div>

            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/447e81cc-a5f1-46c5-b2cf-b11e4f6c6651"
                method="POST" className="flex flex-col w-full md:w-1/2">
                    <input 
                    type="text" name="name" placeholder="Enter
                    ...
                    your email" className="p-2 my-4 bg-transparent border-2
                    rounded-md text-white focus:outline-none"
                    />
                    ...
                    items-center rounded-md hover:scale-110 duration-300">Let's Talk
                    </button>
                </form>
            </div>
        </div>
